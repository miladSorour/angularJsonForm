...
import { UsersSearchComponent } from './dialog-users-search/users-search.component';
...
export class AppInputUsersComponent extends AppBaseInputModel<AppInputBaseConfig> implements DoCheck, OnInit, OnChanges {
  ...
  onSuffixIconClicked() {
    ...
    this.appDialogService.openDialog<UsersSearchComponent, UserModel>(UsersSearchComponent, groupDialogModel)
  }
