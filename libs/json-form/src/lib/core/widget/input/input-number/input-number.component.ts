...
export class InputNumberComponent extends AppBaseInputModel<AppInputBaseConfig> implements DoCheck, OnInit, OnChanges {
  ...
  isControlHasError(controlName: string, validationType: string): boolean {
    if(this.inputForm && Object.keys(this.inputForm).includes('controls')){
  ...
  private initForm() {
    ...
    this.inputForm.controls['myInput'].addValidators(this.control.control.validator);
  }
