...
import { OrganizationSearchComponent } from './dialog-organization-search/organization-search.component';
import { OrganizationService } from '../../../service/organization.service';

@Component({
  // eslint-disable-next-line @angular-eslint/component-selector
  selector: 'ac-input-organization',
  templateUrl: './a-c-input-organization.component.html'
})
// eslint-disable-next-line @angular-eslint/no-conflicting-lifecycle
export class ACInputOrganizationComponent extends AppBaseInputModel<AppInputBaseConfig> implements DoCheck, OnInit, OnChanges {
  ...
  onSuffixIconClicked() {
      ...
      onClose: (res: Organization) => {
        if (res) {
          if(this.value !== res.id) {
            ...
            this.appFormConfig.formGroup.patchValue({[control.selectedTitle!]: this.selectedTitle})
    ...
    this.appDialogService.openDialog<OrganizationSearchComponent, Organization>(OrganizationSearchComponent, organizationDialogModel)
  }
