...
export class MetronicComponent implements OnInit, AfterViewInit {
  // Public variables
  selfLayout = 'default';
  ...
  constructor(
    ...
    this.environmentService.environment=this.route.snapshot.data.environment
  ...
  ngOnInit(): void {
    ...
    this.route.data.subscribe((value) => {
      if(value && Object.keys(value).includes('menuList')){
        this.menuListDemo=value.menuList
      }
  })
  }
