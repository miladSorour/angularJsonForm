...
import {NotificationsSgsComponent} from "./dropdown-inner/notification-sgs/notifications-sgs.component";
import {BookmarkInnerComponent} from "./dropdown-inner/bookmark-sgs/bookmark-inner.component";
...
@NgModule({
  declarations: [
    ...
    NotificationsSgsComponent,
    BookmarkInnerComponent
  ],
  imports: [CommonModule, FormsModule, InlineSVGModule, RouterModule, TranslateModule, NgbTooltipModule],
  exports: [
    NotificationsInnerComponent,
    QuickLinksInnerComponent,
    SearchResultInnerComponent,
